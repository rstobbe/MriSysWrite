...
function [SCRPTipt,SCRPTGBL,err] = WrtMeth_SiemensYarnball_v2a_NumFileSel(SCRPTipt,SCRPTGBL)
...
PanelScriptUpdate_B9(RWSUI.curpanipt-4,RWSUI.tab,RWSUI.panelnum);                           % 3 between top calling
