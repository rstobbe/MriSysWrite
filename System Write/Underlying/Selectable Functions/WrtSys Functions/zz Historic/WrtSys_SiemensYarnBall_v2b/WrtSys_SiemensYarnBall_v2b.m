%=========================================================
% (v2b)
%       - include 'recononly' option
%=========================================================

function [SCRPTipt,SYSWRT,err] = WrtSys_SiemensYarnBall_v2b(SCRPTipt,SYSWRTipt)
...
SYSWRT.recononly = SYSWRTipt.('ReconOnly');
...
PRMWRT.method = 'WrtParam_SiemensYarnBall_v1b';
