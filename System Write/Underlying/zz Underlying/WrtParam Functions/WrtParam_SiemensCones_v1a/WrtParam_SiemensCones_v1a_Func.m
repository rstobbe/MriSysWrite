...
function [PRMWRT,err] = WrtParam_SiemensCones_v1a_Func(PRMWRT,INPUT)

Status2('busy','Write Parameters for Siemens Cones',2);
Status2('done','',3);
...
% Test
%-------------------------------------------------
if not(strcmp(IMP.DES.type,'Cones'))
    err.flag = 1;
    err.msg = 'WrtParam function only for Cones designs';
    return
end
...
%----------
dimx = ORNT.dimx;                                           % Cones has no elip support
dimy = ORNT.dimy; 
dimz = ORNT.dimz; 
%----------
