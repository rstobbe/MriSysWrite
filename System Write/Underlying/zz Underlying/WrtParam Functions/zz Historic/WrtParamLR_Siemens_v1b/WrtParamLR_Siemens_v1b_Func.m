...
function [PRMWRT,err] = WrtParamLR_Siemens_v1b_Func(PRMWRT,INPUT)

Status2('busy','Write Parameters for Siemens LR Acquisition',2);
Status2('done','',3);
...
% Projection Sampling
%-------------------------------------------------
pusamp = length(IMP.projsampscnr)/IMP.PROJimp.nproj;
...
susamp = num2str(str2double(IMP.DES.SPIN.number)*pusamp,'%4.0f');
nusamp = num2str(str2double(IMP.DES.SPIN.number)*pusamp/100,'%4.2f');
