%=========================================================
% (v1c)
%       - added 'elip' and 'ProjSet'
%=========================================================

function [WRT,SCRPTipt,err] = WrtParam_REALVSL_v1c(WRT,SCRPTipt,err)

Status('busy','Write Projection Set Parameter Files');
...
fprintf(fid,['ProjSet = ''',WRT.ProjSet,'''\n']);
